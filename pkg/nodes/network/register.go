...
func RegisterAllNodes(registry *node.Registry) {
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "url", Label: "URL", Type: "string", Default: "", Description: "Target URL (can be set via msg.url)"},
			{Name: "timeout", Label: "Timeout (s)", Type: "number", Default: 30, Description: "Request timeout in seconds"},
			{Name: "retryCount", Label: "Retry Count", Type: "number", Default: 0, Description: "Number of retries on failure"},
			...
			{Name: "basicAuthPassword", Label: "Basic Auth Password", Type: "string", Default: "", Description: "Password for HTTP Basic Authentication"},
	...
	registry.Register(&node.NodeInfo{
		...
		Color:       "#06b6d4",
		Properties: []node.PropertySchema{
			{Name: "statusCode", Label: "Status Code", Type: "number", Default: 200, Description: "HTTP response status code"},
		},
		Inputs: []node.PortSchema{
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "password", Label: "Password", Type: "string", Default: "", Description: "Broker authentication password"},
			...
			{Name: "keepAlive", Label: "Keep Alive (s)", Type: "number", Default: 60, Description: "Keep alive interval in seconds"},
