...
func RegisterAllNodes(registry *node.Registry) {
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "port", Label: "Port", Type: "number", Default: 3306, Required: true, Description: "MySQL server port", Min: node.FloatPtr(1), Max: node.FloatPtr(65535)},
			...
			{Name: "password", Label: "Password", Type: "password", Default: "", Description: "Database password"},
		},
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "port", Label: "Port", Type: "number", Default: 5432, Required: true, Description: "PostgreSQL server port", Min: node.FloatPtr(1), Max: node.FloatPtr(65535)},
			{Name: "database", Label: "Database", Type: "string", Default: "", Required: true, Description: "Database name to connect to"},
			{Name: "username", Label: "Username", Type: "string", Default: "", Required: true, Description: "Database username"},
			{Name: "password", Label: "Password", Type: "password", Default: "", Description: "Database password"},
	...
	registry.Register(&node.NodeInfo{
		...
		Color:       "#47a248",
		Properties: []node.PropertySchema{
			{Name: "uri", Label: "Connection URI", Type: "string", Default: "mongodb://localhost:27017", Required: true, Description: "MongoDB connection string", Placeholder: "mongodb://localhost:27017"},
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "port", Label: "Port", Type: "number", Default: 6379, Required: true, Description: "Redis server port", Min: node.FloatPtr(1), Max: node.FloatPtr(65535)},
			{Name: "password", Label: "Password", Type: "password", Default: "", Description: "Redis server password"},
			{Name: "db", Label: "Database Index", Type: "number", Default: 0, Description: "Redis database index (0-15)", Min: node.FloatPtr(0), Max: node.FloatPtr(15)},
		},
		Inputs: []node.PortSchema{
	...
	registry.Register(&node.NodeInfo{
		...
		Properties: []node.PropertySchema{
			...
			{Name: "token", Label: "API Token", Type: "password", Default: "", Required: true, Description: "InfluxDB authentication token"},
			...
			{Name: "batchSize", Label: "Batch Size", Type: "number", Default: 1000, Description: "Number of points to batch before flushing", Min: node.FloatPtr(1)},
